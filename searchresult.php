...
<?php
$sql3=("select * from products where (pname like '%$s%') OR (pcategory like '$s%') OR (pprice like '%$s%')");
...
?>					
					  <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<?php echo "<a href='addtocart-searchresult.php?pcode=$a'><input type='submit' name='submit' value='Add to cart' class='button' /></a>";?></div>
						...
						<?php } } 
							...
							echo "<h3 class='wthree_text_info'>No Result Found</h3>";
						}

			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item menu__item"><a class="menu__link" href="about.php">About</a></li>
...
<?php
$sql1="select * from products where pcategory='womens'";
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										...
										<div class='snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2'>
																	...
																	<?php echo "<a href='addtocart-womens.php?pcode=$a'><input type='submit' name='submit' value='Add to cart' class='button' /></a>";?></div>
														</div>

		  ...
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w31">
							...
							<h4>Address</h4>
							<p>Plot No ST-1/8, Sector No 36-1, Korangi 5<span>Sherabad Colony Sector 36 C Landhi Town, Karachi, Karachi City, Sindh</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>Call Us</h4>
							<p>(021) 35035542<span>(+92)021-35035543</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:info@wmomiti.com">info@wmomiti.com</a><span><a href="mailto:info@wmomiti.com">mgmt@wmomiti.com</a></span></p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
						...
						<h4>For More <span>Information</span></h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Telephone </p><span>021-35035543</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:info@wmomiti.com">info@wmomiti.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Plot No ST-1/8,</p><span> Sector No 36-1, Korangi 5
Sherabad Colony Sector 36 C Landhi Town, Karachi, Karachi City, Sindh.</span>
								</div>
								<div class="clearfix"> </div>
							</div>

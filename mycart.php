...
$sql="select * from popularproducts";
?>
<html>
<head>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign In <span>Now</span></h3>
									<form action="signin-mycart.php" method="post">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign Up <span>Now</span></h3>
						 <form action="signup-mycart.php" method="post" onsubmit="return validatesignup()">
...
<br/>
<div class="container">
<div class="jumbotron col-sm-12 table-responsive" style="overflow-x: auto;overflow-y: hidden;">



<h2 align="center"><b> ALL PRODUCTS: </b></h2>
<hr/>

<table class="table table-hover">

<tr><th>S.No</th> <th>Image</th> <th>Product Code</th><th>Quantity</th><th>Unit Price</th><th>Amount</th></tr>
...
echo "<tr><td>$count</td> <td><img src='$pimg' width=50 height=50></td> <td>$pcode</td><td><input type=number min=1 max=10 value='$a'></td><td>$price</td><td>$amount</td><td><a href='deleteitemfromcart.php?index=$pcode'><button type=submit class='btn-sm' style='color: white;background-color: black;'>Delete Item</button></a></td></tr>";
$i++;
$count++;
}
echo "<tr><td colspan=5 align=right> Total Amount:</td><td><b>$total</b></td></tr>";
?>

<tr><td colspan=5 align=right><a href="empty.php?pcode=$pcode"><button type=submit class="btn-lg"  onMouseOver="this.style.backgroundColor='#2fdab8'"
        onMouseOut="this.style.backgroundColor='black'" style="color: white;background-color: black;">Empty Cart</button></a></td><td><a href="check-mycart.php"><button type=submit class="btn-lg"  onMouseOver="this.style.backgroundColor='#2fdab8'"
        onMouseOut="this.style.backgroundColor='black'" style="color: white;background-color: black;">Checkout</button></a></td></tr>

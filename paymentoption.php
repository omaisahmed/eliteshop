...
<div class="header" id="home">
	<div class="container">
		...
		<div class="dropdown"> <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">    <input type="hidden" ><?php echo $_SESSION["name"]; ?>                    
                                <i class="glyphicon glyphicon-user"></i>
                                                               <b class="caret"></b></a>
                                <ul class="dropdown-menu" style="background-color: white;">
                                 
                                    <li><a href="logout-main.php"  style="background-color: white;color: black;">Logout</a></li>
                                </ul>
                            </li></div>
                        </ul>
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		<div class="col-md-4 header-middle">
			...
			<div class="col-md-4 logo_agile">
				<h1><a href="index.php"><span>E</span>lite Shoppy</a></h1>
			</div>
...
<h2 align="center"><b> Select Payment Option: </b></h2><br>
<table class="table  table-hover">
<tr><td align="right"><input type=radio value="Cash" name=p1 style="width: 50%;height: 1.5em;"></td><td align="left"><font size=+2>Cash on Delivery</font></td></tr>
<tr><td align="right"><input type=radio value="2Checkout" name=p1 style="width: 50%;height: 1.5em;"></td><td align="left"><font size=+2>2Checkout</font></td></tr>
<tr><td colspan=2 align="center"><button type=submit class="btn-lg"  onMouseOver="this.style.backgroundColor='#2fdab8'"
        onMouseOut="this.style.backgroundColor='black'" style="color: white;background-color: black;">Next</button></td></tr>
</table>
		</form>
 </div>
</div>
...
Sherabad Colony Sector 36 C Landhi Town, Karachi, Karachi City, Sindh. 
		...
		<p class="copy-right">&copy 2019 Elite Shop. All rights reserved | Design by <a href="https://omais-ahmed.blogspot.com/">Omais Ahmed</a></p>
	</div>
</div>

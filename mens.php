...
<div class="header" id="home">
	<div class="container">
		<ul>
			...
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">info@wmomiti.com</a></li>
		</ul>
	</div>
</div>
<!-- //header -->
...
<?php
$sql1="select * from products where pcategory='mens'";
				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										...
										<img src='$d' alt='' class='pro-image-back'>
											<div class='men-cart-pro'>
												<div class='inner-men-cart-pro'>
													<a href='cart.php?img=$d&name=$b&price=$c&delprice=$f&pcode=$a' class='link-product-add-cart'>Quick View</a>
												</div>
											</div>
									...
									<div class='item-info-product'>
										...
										<div class='info-product-price'>
											<span class='item_price'>Rs.$c</span>
											<del>Rs.$f</del>
										</div>
										<div class='snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2'>"; ?>
															
																	<?php echo "<a href='addtocart-mens.php?pcode=$a'><input type='submit' name='submit' value='Add to cart' class='button' /></a>";?></div>
